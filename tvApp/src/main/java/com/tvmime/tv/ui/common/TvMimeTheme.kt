...
val TvMimeDefaultPalette = StreamMatePalette(
    ...
    focus = Color(0xFFDC143C),
    secondaryGlow = Color(0xFF8B0000),
...
// Legacy aliases retained for source compatibility. Theme-aware UI should read TvMimeThemeTokens.
val TvMimeBackground = TvMimeDefaultPalette.background
val StreamMateSurface = TvMimeDefaultPalette.surface
val StreamMateSurfaceRaised = TvMimeDefaultPalette.surfaceRaised
val StreamMateCyan = TvMimeDefaultPalette.focus
val StreamMateOrange = TvMimeDefaultPalette.accent
val StreamMateRed = TvMimeDefaultPalette.danger
val StreamMateMuted = TvMimeDefaultPalette.textMuted
...
private val LocalStreamMatePalette = staticCompositionLocalOf { TvMimeDefaultPalette }
...
@Composable
fun TvMimeTheme(
    palette: StreamMatePalette = TvMimeDefaultPalette,
